            ...
            <table className="w-full border-collapse bg-white shadow-md rounded-lg overflow-hidden">
                <thead>
                    <tr className="bg-blue-500 text-white">
                        <th className="border border-gray-300 px-6 py-3 text-left">Room ID</th>
                        <th className="border border-gray-300 px-6 py-3 text-left">Guest Name</th>
                        <th className="border border-gray-300 px-6 py-3 text-left">Check-out Date</th>
                ...
                <tbody>
                    {rooms.map((room, index) => (
                        <tr key={room.id} className={`${index % 2 === 0 ? "bg-gray-50" : "bg-white"} hover:bg-blue-50`}>
                            <td className="border border-gray-300 px-6 py-3 text-left font-medium text-gray-800">{room.id}</td>
                            <td className="border border-gray-300 px-6 py-3 text-left font-medium text-gray-800">{room.guestName}</td>
                            <td className="border border-gray-300 px-6 py-3 text-left font-medium text-gray-800">{room.checkOutDate}</td>
                            <td className={`border border-gray-300 px-6 py-3 text-left font-medium rounded ${getStatusClass(room.status)}`}>{room.status}</td>
                        </tr>
                    ))}
                </tbody>
            </table>
